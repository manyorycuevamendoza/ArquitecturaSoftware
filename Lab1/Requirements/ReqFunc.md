...
## Emergencias y aviso a otro responsable
...
| RF-EME-02 | Si el responsable no confirma lectura o respuesta en 90 s, el sistema debe avisar automáticamente al médico alterno y al jefe de guardia definidos para el turno. Cada aviso y confirmación debe quedar registrado. | En el 100% de pruebas sin confirmación inicial, se avisa a ambos responsables a los 90 s ± 5 s y la bitácora contiene entrega, lectura/respuesta y destinatarios. | Enfermera de UCI |
| RF-NOT-01 | El sistema debe enviar notificaciones de cambios críticos solo a profesionales autorizados que estén asignados al paciente o que formen parte de la regla vigente de aviso a otro responsable. | En una prueba con pacientes y turnos distintos, el 100% de notificaciones llega únicamente a los destinatarios correspondientes; los demás no la reciben. | Médico internista |
