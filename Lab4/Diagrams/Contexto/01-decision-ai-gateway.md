...
Lima) ya está resuelto en [../Architecture.md](../../4-Arquitectura/Architecture.md). Este
...
diagrama de flujo de IA en [../Architecture.md](../../4-Arquitectura/Architecture.md) hoy dibuja
